...
public class turret : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        mouseScreenPos.z = gameCam.transform.position.y - gameObject.transform.position.y;  //distance from Camera to player
        Vector3 mouseWorldPos = gameCam.ScreenToWorldPoint(mouseScreenPos); //convert mouseSreenPos from 2D to 3D with the missing z component to distance from Camera
